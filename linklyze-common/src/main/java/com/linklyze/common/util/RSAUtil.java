...
public class RSAUtil {
	...
	public static void main(String[] args) throws Exception{
		String str = RSAUtil.encrypt("1234");
		System.out.println(str);

		String decrypt = decrypt("I+2ez1Fdt8h+EmzlYspkt/jncp3gn31i2fno1f5TMOMQH8F8z3gogTCeovl++yjKxNLC59RBLQ1dQPptKoGeq3s/6IPEfGYsCPjH3kA+h3JL/BgpDoo6F3NvYT7JDt0jHlK/ODUE/N8HUHYCDzaKnXbeiDz2rMEyqRCSitQefmE=");
